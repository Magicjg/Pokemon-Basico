            ...
            if my_position[POS_X] == coordinate_x and my_position[POS_Y] == coordinate_y:
                ...
                if trainer_in_cell:
                    ...
                    while vida_actual_pikachu > 0 and vida_actual_enemy_pokemon > 0:
                        ...
                        while ataque_pikachu not in ["B", "T", "C"]:
                            ataque_pikachu = input(
                                "¿Que ataque deseas realizar? [B]ola Voltio, [T]rueno [C]Cola de Hierro: ")

                        if ataque_pikachu == "B":
                            print("Pikachu ataca con Bola Voltio")
                            vida_actual_enemy_pokemon -= 18
                        elif ataque_pikachu == "T":
                            print("Pikachu ataca con Trueno")
                            vida_actual_enemy_pokemon -= 21
                        elif ataque_pikachu == "C":
                            print("Pikachu ataca con Cola de Hierro")
